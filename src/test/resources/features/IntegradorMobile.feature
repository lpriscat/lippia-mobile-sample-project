...
Scenario: The user is logged in the application and changes the status of a button in a successful way
...
Scenario: The user is logged in the application and adds a time entry to a project
